...
Frameworks & Libraries: Django, Django REST Framework, SimpleJWT
Databases: PostgreSQL
Tools & Platforms: Docker, Git, GitHub Actions (CI/CD), Render/Heroku deployment
Other: Authentication & Authorization, API Design, Testing (unit/integration), Performance Optimization (indexing, caching)

Featured Projects
DevTasker: Task Management & Collaboration Platform

Description: A full-featured backend-first application blending Trello, Notion, and Slack. Includes user management with custom models, JWT authentication, social login (Google), task/project models with priorities and relationships, REST APIs for CRUD operations, mock payment gateway for project completion, and secure permissions.
...
Looking forward to collaborating on robust backend solutions—let's connect!
